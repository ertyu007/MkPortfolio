          ...
          >
            ...
            <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-lg">
              ...
              <div className="grid grid-cols-3 gap-4">
                <a href="#" className="group bg-gray-100 dark:bg-gray-800 rounded-xl p-4 text-center hover:bg-blue-50 dark:hover:bg-blue-900/30 transition-colors">
                ...
                <a href="#" className="group bg-gray-100 dark:bg-gray-800 rounded-xl p-4 text-center hover:bg-blue-50 dark:hover:bg-blue-900/30 transition-colors">
                  <div className="w-12 h-12 mx-auto mb-2 bg-blue-400 rounded-lg flex items-center justify-center group-hover:bg-blue-500 transition-colors">
                    <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
